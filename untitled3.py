# -*- coding: utf-8 -*-
"""
Created on Wed Sep 14 19:33:37 2022
...
df2 = df[['Genre','Annual Income (k$)','Spending Score (1-100)']]
...
mtp.contourf(x1, x2,lgr.predict(nm.array([x1.ravel(), x2.ravel()]).T).reshape(x1.shape),alpha = 0.75, cmap = ListedColormap(('purple','green')))  
